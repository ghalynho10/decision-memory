...
- [ ] Build it: `/develop jsmastery specs adapter`
  ...
  - [ ] Narrow the unresolved mention count to path shaped tokens: the shape test on the pre strip token, the case insensitive known extension constant, occurrences not distinct (AC-6)

...
- [ ] Build it: `/develop abstention verification reliability`
  ...
  - [ ] Tell generation which field each evidence chunk is, and instrument the additive split, then measure both in one set of runs (AC-12, AC-17, AC-18, AC-19) — settled 2026-08-13 as AC-18 and AC-19; runs before calibration

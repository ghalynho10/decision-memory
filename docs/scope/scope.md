...
- [ ] Build it: `/develop abstention verification reliability`
  ...
  - [ ] Run the cheap self corpus gate against that fixture and re-measure the drop rates on a clean pipeline (AC-4, AC-12, AC-14)

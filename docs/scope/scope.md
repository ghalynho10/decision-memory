...
- [ ] Build it: `/develop abstention verification reliability`
  ...
  - [ ] Record the offending token on both halves, replace the directional stem matcher with the base set intersection, then re-measure live (AC-1, AC-11, AC-19, AC-20) — the blocking milestone, settled 2026-08-14 as spec 0010 OD-8 and spec task 18; runs before the calibration below
